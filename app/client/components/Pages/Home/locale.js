...
const i18n = new LocalizedStrings({
  en:{
    ...
    signIn: 'Sign In',
    heroText2: 'We work with Municipalities, Urban Developers, Architects, Engineers, Non-Profits, Community Groups, Universities, Research Institutes and many other organizations.',
    launchProject: 'Get Citizen Insight',
